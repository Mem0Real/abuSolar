  ...
  return (
    <footer className="text-gray-400 bg-stone-900 body-font mt-12 md:mt-0">
      <div className="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col md:flex-row lg:flex-row">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-white border border-y-0 border-l-0 rounded-lg mr-2">
          <span className="ml-3 text-xl">AbuSolarTech</span>
        </a>
